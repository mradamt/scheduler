...
storiesOf("DayListItem", module) // Initiates Storybook and registers our DayListItem component
  ...
  .add("Clickable", () => (
    <DayListItem name="Tuesday" setDay={(event) => action("setDay")("Wednesday")} spots={5} /> // action() allows us to create a callback that appears in the actions panel when clicked
  ));
